...
<body>
	...
	<section id="header">
		<header>
			<span class="image avatar"><img
				src="images/ava.png" alt="" /></span>
			<h1 id="logo">
				<a href="#">Heung Seop Kim</a>
			</h1>
			<p>
				Hoseo university<br /> computer engineering
			</p>
		</header>
		<nav id="nav">
			<ul>
		...
		<div id="main">
			...
			<section id="one">
				<div class="container">
					<header class="major">
						<h2>Heung Seop</h2>
						<p>	안녕하세요. 김흥섭입니다. <br />
							<!-- freebie by <a href="http://html5up.net">HTML5 UP</a>.
					 -->	</p>
					</header>
					<p></p>
				</div>
			...
			<section id="two">
				<div class="container">
					...
					<p>jsp web programmer</p>
					<ul class="feature-icons">
						<li class="fa-code">Java</li>
						<li class="fa-amazon">Amazon Web Service</li>
						<li class="fa-android">Android</li>
						<li class="fa-camera">Take a picture</li>
					</ul>
				</div>
			</section>
			...
			<section id="three">
				<div class="container">
					...
					<p>졸업작품 입니다. STS를 사용하였고 데이터베이스는 Oracle, 서버는 톰캣을 사용하였습니다. Amazon Web Service를 사용하여 
					가상서버를 두고 서비스 제공중 입니다. </p>
					<div class="features">
						<article>
							<a href="#" class="image"><img src="images/pic01.png" alt="" /></a>
							<div class="inner">
								<h4>HEALING</h4>
								<p>관광지를 등록하고 연결하여 코스를 만들고 공유하는 페이지 입니다. 
								sping을 사용하였고 html, css, JavaScript, Jquery, Json, Ajax, BootStrap, JDBC, MyBatis를 
								사용하였고 jsp를 기반으로 두고 mvc패턴을 지키고 있습니다.</p>
							</div>
						</article>
						<article>
							<a href="#" class="image"><img src="images/pic02.png" alt="" /></a>
							<div class="inner">
								<h4>AWS(Amazon Web Service)</h4>
								<p>아마존 웹서비스에 윈도우즈 서버를 두고 서비스중에 있습니다. 지금 보고있는 페이지도 같은 서버입니다. 
								RDS는 만들었으나 무료계정에서는 속도가 너무 느려 사용하지 않고 있습니다. </p>
							</div>
						</article>
					</div>
				</div>
	...
	print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
									...
									<section>
										<h4>Image</h4>
										<h5>Fit</h5>
										<span class="image fit"><img src="images/ban.jpg" alt="" /></span>
										<div class="box alt">
